  ...
  <BFullPage>
    ...
    <BPartPageBody>
      ...
      >
        ...
        <p class="mt-3 mb-1 text-md">ค่าไฟ (บาท)</p>
        <UInput v-model="value" />
        <p class="mt-3 mb-1 text-md">ค่าน้ำ (บาท)</p>
        <UInput v-model="value" />
        <p class="mt-3 mb-1 text-md">หนี้ กยส. (บาท)</p>
        <UInput v-model="value" />
        <p class="mt-3 mb-1 text-md">หนี้ กบข. (บาท)</p>
        <UInput v-model="value" />
        <p class="mt-3 mb-1 text-md">หนี้อื่นๆ (บาท)</p>
        <UInput v-model="value" />

        </UCard>
        <div class="flex justify-end">
          <UButton @click="navigateTo('/loansharemember/create')">บันทึก</UButton>
        </div>
