<template>
  <BFullPage>
    ...
    <!-- <UButton to="/registermemberCounter/linkeCheck">ปริ้นรายงาน</UButton> -->

    <BPartPageBody>
      <BPartButtonsBand>
        <div class="flex justify-end gap-8">
          <UButton @click.self="toggleModal">แชร์ลิงค์</UButton>
        </div>
        <template #next>
          <DSmartTabs />
        </template>
...
const pageDef = useActiveModulePage('list.linkeCheck');
useBreadcrumb('List');
