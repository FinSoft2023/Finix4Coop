...
<div data-dial-init class="fixed end-6 bottom-6 group">
  <!-- เปลี่ยน flex-col เป็น flex-row และเพิ่ม space-x-2 -->
  <div id="speed-dial-menu-square" class="flex flex-row items-center hidden mb-4 space-x-2">
    <!-- ปุ่ม Share -->
