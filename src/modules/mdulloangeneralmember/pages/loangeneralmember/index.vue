<template>
  <BFullPage>
    ...
    <BPartPageBody>
      <BPartButtonsBand>
        <UButton to="/loangeneralmember/create/confirm"
          icon="i-heroicons-plus-circle">เตรียมข้อมูลขอกู้</UButton>
        <UButton to="/loangeneralmember/create/confirm"
          icon="i-heroicons-plus-circle">ขอกู้ออนไลน์</UButton>
        <!-- <template #next>
          <DSmartTabs />
        </template> -->
      </BPartButtonsBand>
            ...
            <div class="grid grid-cols-1 gap-2">
              <div class="flex items-center mb-2">
                ...
                <div class="flex justify-between">
                  ...
                  <p class="flex justify-end text-md text-blue-400 mt-0 mx-3">
                    รอติดต่อเจ้าหน้าที่
                  </p>
                </div>
              </div>
