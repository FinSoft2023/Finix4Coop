            ...
            <div>
              <div class="text-gray-600">
                <div class="grid grid-cols-2 gap-2">
                  ...
                  <div>
                    <p class="text-md mx-3 text-gray-400 ">รูปแบบการชำระ</p>
                    <p class="text-md font-bold mx-3">ชำระเงินต้นเท่ากัน </p>
                  </div>
                  <div>
                    <p class="text-md mx-3 text-gray-400 ">วงเงินกู้</p>
                    <p class="text-md font-bold mx-3">45,000.00 </p>
                  </div>
                  <div>
                    <p class="text-md mx-3 text-gray-400 ">ชำระแล้วกี่งวด</p>
                    <p class="text-md font-bold mx-3">4 </p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="text-gray-600">
                <div class="grid grid-cols-2 gap-2">
                  <div class="col-span-2 flex items-center mb-2">
                    ...
                    <p class="flex justify-center text-md mt-0 font-bold mx-3">RINDA JUTTANO
                    </p>
                  </div>
                  <div>
                    <p class="text-md mx-3 text-gray-400 ">ทะเบียนสัญญา</p>
                    <p class="text-md sfont-bold mx-3">ส 56/6 </p>
                  </div>
                  <div>
                    <p class="text-md mx-3 text-gray-400">สถานะภาพสัญญา</p>
                    <p class="text-md font-bold mx-3">ชำระปกติ</p>
                  ...
                  <div>
                    <p class="text-md mx-3 text-gray-400 ">ชำระต่องวด</p>
                    <p class="text-md font-bold mx-3">3,800.00 บาท</p>
                  </div>
                  <div>
                    <p class="text-md mx-3 text-gray-400 ">ยอดคงเหลือ</p>
                    <p class="text-md font-bold mx-3">41,200.00 บาท</p>
                  </div>
                  <div>
                    <p class="text-md mx-3 text-gray-400 ">วันที่กู้</p>
                    <p class="text-md font-bold mx-3">20/02/2557</p>
                  ...
                  <div>
                    <p class="text-md mx-3 text-gray-400 ">ชำระแล้วกี่งวด</p>
                    <p class="text-md font-bold mx-3">1 </p>
                  </div>
                </div>
              </div>
            </div>
...
label: 'ข้อมูลค้ำประกันให้ผู้อื่น'
}];
